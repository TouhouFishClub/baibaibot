...
const renderChatPersonas = (callback) => {
	...
	let image = fs.readFileSync(path.join(__dirname, 'logo.png'));
	let base64Image = new Buffer.from(image).toString('base64');
	let imageBg = 'data:image/png;base64,' + base64Image
...
<html>
    ...
    <body>
        ...
        <script>
            ...
            // var keywords = ${JSON.stringify(chatData)}
            var keywords = {
		"visualMap": 22199,
		"continuous": 10288,
		"contoller": 620,
