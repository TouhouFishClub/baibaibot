...
module.exports = function(callback) {
  let optionsetInfo = fs.readFileSync(path.join(__dirname, 'optionset_R373'), 'utf-8')
  let optionsetXml = fs.readFileSync(path.join(__dirname, 'optionset_R373.xml'), 'utf-8')
