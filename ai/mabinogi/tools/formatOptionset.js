...
module.exports = function(callback) {
  let optionsetInfo = fs.readFileSync(path.join(__dirname, 'optionset_R368'), 'utf-8')
  let optionsetXml = fs.readFileSync(path.join(__dirname, 'optionset_R368.xml'), 'utf-8')
