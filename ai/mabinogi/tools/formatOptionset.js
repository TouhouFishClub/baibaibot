...
module.exports = function(callback) {
  let optionsetInfo = fs.readFileSync(path.join(__dirname, 'optionset_R365'), 'utf-8')
  let optionsetXml = fs.readFileSync(path.join(__dirname, 'optionset_R360.xml'), 'utf-8')
