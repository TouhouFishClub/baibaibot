...
module.exports = function(callback) {
  let optionsetInfo = fs.readFileSync(path.join(__dirname, 'optionset_R383'), 'utf-8')
  let optionsetXml = fs.readFileSync(path.join(__dirname, 'optionset_R383.xml'), 'utf-8')
