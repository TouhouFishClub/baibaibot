...
module.exports = function(callback) {
  let optionsetInfo = fs.readFileSync(path.join(__dirname, 'optionset_R367'), 'utf-8')
  let optionsetXml = fs.readFileSync(path.join(__dirname, 'optionset_R367.xml'), 'utf-8')
