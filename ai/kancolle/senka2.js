        ...
        if (error && error.code) {
          ...
          try {
            ...
            (async () => {
              ...
              console.log("请求耗时:", new Date().getTime() - clock, "ms");
              ...
              let _f = (_d) => {
                for (let [left, right] of _d.pos) {
                  ...
                  var_cnt = [...func.matchAll(/var /g)].length;
                  for_cnt = [...func.matchAll(/for\(/g)].length;
                  while_cnt = [...func.matchAll(/while\(/g)].length;
                  if_cnt = [...func.matchAll(/if\(/g)].length;
                  typeof_cnt = [...func.matchAll(/typeof /g)].length;
                  return_cnt = [...func.matchAll(/return /g)].length;
              ...
              let res = front_data.body.slice(0, front_data.body.search(/\]/)).split(",");
