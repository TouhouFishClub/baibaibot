...
function AIdraw(content,gid,qq,callback){
  ...
  var promptchat2  = '随机挑选一个二次元动漫的女主角，并描述她的人设，按照如下格式\n  第一行写中文的名字。第二行描述故事背景和人物介绍，不少于150字。第三行为她写一句符合人设的台词。第四行为她写20个符合人设的中文关键词。第五行把上一行的关键词翻译成英语，关键词用逗号隔开。最后一行写该人物的英文名，然后在大括号{}内写该人物的出处的英文名。请一定要严格按照我说的格式去写这6行，不许在其他任何地方出现换行符。';
  var promptchat''
  if(content=='抽卡1'){
